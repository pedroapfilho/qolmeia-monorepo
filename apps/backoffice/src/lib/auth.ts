...
//
// nextCookies() must be the last plugin — it intercepts the response to
// forward Set-Cookie headers into server action / RSC context. Any plugin
// registered after it would not see the session cookies it sets.
//
