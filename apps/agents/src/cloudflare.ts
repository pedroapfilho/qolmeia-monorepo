...
// discovered as `cloudflare.ts` in the source root (src/). Exposes the approval
// Workflow class (wrangler.jsonc binds it by name; Flue doesn't generate it)
// plus non-HTTP Worker handlers. All agents are Flue agents now.
