...
const WelcomeEmail = ({ userEmail, username, verificationUrl }: WelcomeEmailProps) => {
  return (
    <BaseLayout preview="Welcome to Qolmeia. Verify your email to get started.">
      ...
      <Text className="m-0 mb-4 text-sm text-muted-foreground">
        If you didn&apos;t create an account with Qolmeia, you can safely ignore this email. The
